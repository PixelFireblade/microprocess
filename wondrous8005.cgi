...
my $sql = 'SELECT zid FROM wondrous WHERE zid = ?';
my $sth = $dbh->prepare($sql);
$sth->execute($zid);
my @tempTest = $sth->fetchrow_array;
if(@tempTest) {
$dbh->do('UPDATE wondrous SET state = ?, result = ?, time = ? WHERE zid = ?',
  undef,
  param('state'),
  param('successful'),
  param('time'),
...
$dbh->do('INSERT INTO wondrous (zid, state, result, time) VALUES (?, ?, ?, ?)',
  undef,
...
$state = '""';
my $sql = 'SELECT state, result FROM wondrous WHERE zid = ?';
my $sth = $dbh->prepare($sql);
$sth->execute($zid);
...
<html lang="en">
	<head>
		<title>SPuD - Wondrous 8005</title>
                 <meta http-equiv="refresh" content="0; url=https://cgi.cse.unsw.edu.au/~cs1917ass/emulator/OLApps_SPuD/standalone/ui/wondrous8005.html">
	...
	<body>
		...
		<center>
			...
			<a href="#" class="btn btn-success" id="automark-button">Check my Wondrous 8005</a>
			<br/>
		</center>
...
[
...

    {
        ...
        "test": [
            ...
            },
            {
                ...
                "parameter": "R0",
                "match": 15,
                "correctComment": "Passed: RO = 15. (the term after 30)",
                "incorrectComment": "Test Failed: R0 should equal 15 (the term after 30)"
            },
            {
                "type": "register",
                "parameter": "R1",
        ...
        "test": [
            {
                ...
                "parameter": "IP",
                "match": 52,
                "correctComment": "Passed: Function returned correctly by jumping to the return address specified in the frame (51).",
                "incorrectComment": "Test Failed: Function did not return correctly by jumping to the return address specified in the frame (ie 53 in this test)"
            },
            {
                "type": "register",
                "parameter": "R0",
                "match": 28,
                "correctComment": "Passed: RO = 28. next term after 9",
                "incorrectComment": "Test Failed: R0 should equal 28. (next term after 9)"
            },
            {
                "type": "register",
                "parameter": "R1",
    ...
    },
    {
        ...
        "test": [
            ...
            },
            {
                ...
                "parameter": "R0",
                "match": 0,
                "correctComment": "Passed: RO = 0. (next term after 0)",
                "incorrectComment": "Test Failed: R0 should equal 0. (next term after 0)"
            },
            {
                "type": "register",
                "parameter": "R1",
        ...
        "test": [
            ...
            },
            {
                ...
                "parameter": "R0",
                "match": 0,
                "correctComment": "Passed: RO = 0. (isEven (9) == 0)",
                "incorrectComment": "Test Failed: R0 should equal 0 (isEven (9) == 0)"
            },
            {
                "type": "register",
                "parameter": "R1",
        ...
        "test": [
            {
                ...
                "parameter": "IP",
                "match": 56,
                "correctComment": "Passed: Function returned correctly by jumping to the return address specified in the frame (55).",
                "incorrectComment": "Test Failed: Function did not return correctly by jumping to the return address specified in the frame (ie 55 in this test)"
            },
            {
                "type": "register",
                "parameter": "R0",
                "match": 0,
                "correctComment": "Passed: RO = 0. (isEven (123) == 0)",
                "incorrectComment": "Test Failed: R0 should equal 0 (isEven (123) == 0)"
            },
            {
                "type": "register",
                "parameter": "R1",
    ...
    },
    {
        ...
        "test": [
            {
                ...
                "parameter": "IP",
                "match": 34,
                "correctComment": "Passed: RO is not 0. (isEven (69) != 0)",
                "incorrectComment": "Test Failed: R0 should not be equal to 0. (isEven (69) != 0)"
            },
            {
                "type": "register",
                "parameter": "R1",
       ...
       {
      "name":"Testing Wondrous main program when cell 255 contains 1",
      "setup":[
         {
            "type":"clearRegisters"
         },
      ...
      "test":[
         {
            ...
            "incorrectComment":"Output Doesn't Match (expecting 1)"
         }
      ]
   },
 {
      "name":"Testing when cell 255 contains 2",
      "setup":[
         {
            "type":"clearRegisters"
         },
      ...
      "test":[
         {
            ...
            "match":"2 1",
            "correctComment":"Test passed!",
            "incorrectComment":"Output Doesn't Match (expecting 2 1)"
         }
      ]
   },
   {
      "name":"Testing when cell 255 contains 23",
      "setup":[
         {
            "type":"clearRegisters"
         },
      ...
      "test":[
         {
            "type":"output",
            "match":"23 70 35 106 53 160 80 40 20 10 5 16 8 4 2 1",
            "correctComment":"Test passed!",
            "incorrectComment":"Output Doesn't Match (expecting 23 70 35 106 53 160 80 40 20 10 5 16 8 4 2 1)"
         }
      ]
   },
 {
      "name":"Testing when cell 255 contains 213",
      "setup":[
         {
            "type":"clearRegisters"
         },
      ...
      "test":[
         {
            "type":"output",
            "match":"213 128 64 32 16 8 4 2 1",
            "correctComment":"Test passed!",
            "incorrectComment":"Output Doesn't Match (expecting 213 128 64 32 16 8 4 2 1)"
         }
      ]
   },
 {
      "name":"Testing when cell 255 contains 8",
      "setup":[
         {
            "type":"clearRegisters"
         },
